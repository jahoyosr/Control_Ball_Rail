...
MODEL           = SimulinkProjet
MODULES         = SimulinkProjet_capi.c SimulinkProjet_data.c SimulinkProjet_tgtconn.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = SimulinkProjet.mk
MATLAB_ROOT     = C:\Program Files\MatLab 2016a
ALT_MATLAB_ROOT = C:\PROGRA~1\MATLAB~1
MATLAB_BIN      = C:\Program Files\MatLab 2016a\bin
ALT_MATLAB_BIN  = C:\PROGRA~1\MATLAB~1\bin
MASTER_ANCHOR_DIR = 
START_DIR       = U:\4AE\TP AUTOM\MiniProjet
S_FUNCTIONS     = adnipcie.c danipcie.c xpcionie.c
S_FUNCTIONS_LIB = 
NUMST           = 3
TID01EQ         = 1
NCSTATES        = 4
...
MODELLIB                  = SimulinkProjetlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = SimulinkProjet_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\SimulinkProjet_slrt_rtw
